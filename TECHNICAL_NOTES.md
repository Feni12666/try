...
Before cleanup, the service revalidates the exact recorded destination URI and confirms the source still has the same size/mtime. If any check is uncertain, the source remains.
